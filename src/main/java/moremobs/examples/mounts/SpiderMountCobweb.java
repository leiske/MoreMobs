...
public class SpiderMountCobweb extends GameObject {

    private GameTexture texture;

    public SpiderMountCobweb() {
        super(new Rectangle(0, 0, 0, 0)); // Collision relative to the tile it's placed on
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/spidermountcobweb");
    }
